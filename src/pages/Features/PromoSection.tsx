...
const PromoSection = () => {
  ...
  return (
    <section className="w-full bg-gradient-to-r from-green-400 to-blue-500 py-12 text-center text-white shadow-lg">
      ...
      {/* Call to Action Link */}
      <div className="mt-8">
        <Link to="/bicycles" className="inline-block bg-yellow-500 text-black py-3 px-6 rounded-lg text-lg font-semibold hover:bg-yellow-400 transition duration-300">
          Shop Now
        </Link>
      </div>
    </section>
